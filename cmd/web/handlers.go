...
import (
	...
	"snipper.ancill.com/internal/validator"
)
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.CheckEqual(form.NewPasswordConfirmation, form.NewPassword), "newPasswordConfirmation", "Passwords do not match")
