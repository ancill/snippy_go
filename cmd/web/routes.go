...
func (app *application) routes() http.Handler {
	...
	// page routes with session middleware
	...
	// Protected (authenticated-only) routes, using middleware chain which includes the requireAuthentication middleware.
